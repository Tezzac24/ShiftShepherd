...
3. Apply migrations:
   - **Hosted dev:** remote history is aligned through `20260710031212`. New changes go through `supabase migration new <name>` (leave the generated filename unchanged) and an explicitly approved `supabase db push`. **Do not rename `001`–`006` or timestamped migrations.**
