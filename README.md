...
Every local migration through the chat read-states migration (`20260710031212_add_chat_read_states.sql`, private unread tracking) is pushed and verified — live unread badges are active.
