...
Every local migration through the profile avatar storage migration (`20260710105140_add_profile_avatar_storage.sql`, private avatars bucket + policies + RPC) is pushed and verified — live unread badges and live profile photo uploads are active and QA'd.
