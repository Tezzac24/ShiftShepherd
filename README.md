...
- Remote Supabase migrations are aligned through deployed `20260719110500_add_team_role_management.sql` (33 remote migrations); the team lifecycle and team role migrations are both deployed and hosted-contract verified, and the team creation idempotency migration `20260917093926` is deployed and hosted-contract verified. `manage-organisation-invitations` v2 (UTC invitation-expiry presentation, deployed and verified 2026-09-17) and active-profile-compatible `send-chat-message-push` v5 are deployed. Disposable-account invitation/multi-org QA, team lifecycle and team role manual app QA, and physical-device Expo ticket/banner QA are pending.
