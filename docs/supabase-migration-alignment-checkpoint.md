...
the chat tables remain outside it. The current implementation (through the deployed Rota Push Delivery V1) exports for Android, iOS, and web; its deterministic suite passes 691/70.
...
691 tests across 70 suites. Commits `420e12f` and `bf6a538` repaired auth sign-out
