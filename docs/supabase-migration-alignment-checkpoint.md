...
**Current status on 2026-09-17: remote history is aligned through deployed `20260917180127_fix_invitation_acceptance_role_conflict_target.sql`. All 37 remote migrations are applied, with no local-only, remote-only, or repair entry.**
