...
**Current status on 2026-09-17: remote history is aligned through deployed `20260917124856_add_rota_push_delivery.sql`. All 36 remote migrations are applied, with no remote-only or repair entry. `20260917180127_fix_invitation_acceptance_role_conflict_target.sql` is local-only and awaiting deployment.**
