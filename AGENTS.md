...
- Supabase Auth, Postgres, RLS, Realtime (team chat only), profile-avatar Storage, and implemented-but-local-only announcement-image Storage wired; further Storage use cases and Edge Functions later
