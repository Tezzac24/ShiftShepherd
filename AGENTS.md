...
- Supabase Auth, Postgres, RLS, Realtime (team chat only), and Storage (profile avatars only) wired; further Storage use cases and Edge Functions later
...
- File uploads beyond profile avatars (no announcement images, no chat attachments)
