...
The deployed Broadcast baseline was 211 tests across 31 suites and the pre-membership identity/auth-routing baseline was 296 tests across 43 suites. The current local membership implementation passes 357 tests across 48 suites, adding deterministic lifecycle, last-admin concurrency, cleanup/history, re-invitation, admin UI, role editor, Leave organisation, active-profile transition, and stale-scope coverage.
